...
SITE_TITLE=${WP_SITE_TITLE:-${SITE_TITLE:-gohappychance}}
...
SITE_URL=${WP_SITE_URL:-${SITE_URL:-https://gohappychance.com}}
...
# Activate the bundled gohappychance theme by default (idempotent).
if wp --path=/var/www/html --allow-root theme is-installed gohappychance; then
    wp --path=/var/www/html --allow-root theme activate gohappychance
fi
